...
//    private val viewModel by viewModels<RocketListViewModel>()
    ...
    override fun onCreateView(
        ...
        return ComposeView(requireContext()).apply {
            ...
            val rocket1 =
                Rocket("1", true, "Falcon 1", "24. 3. 2006", "Desc", Height(12.0, 12.0), Height(40.0, 40.0), Mass(55, 55), Stage(true, 27, 1155, 162), Stage(false, 1, 90, 397), listOf("https://farm5.staticflickr.com/4599/38583829295_581f34dd84_b.jpg", "https://farm5.staticflickr.com/4645/38583830575_3f0f7215e6_b.jpg"))
            val rocket2 =
                Rocket("2", true, "Falcon 9", "24. 3. 2006", "Falcon 9 is a two-stage rocket designed and manufactured by SpaceX for the reliable and safe transport of satellites and the Dragon spacecraft into orbit.", Height(12.0, 12.0), Height(40.0, 40.0), Mass(55, 55), Stage(true, 27, 1155, 162), Stage(false, 1, 90, 397), listOf("https://farm5.staticflickr.com/4599/38583829295_581f34dd84_b.jpg", "https://farm5.staticflickr.com/4645/38583830575_3f0f7215e6_b.jpg"))
            val rocket3 =
